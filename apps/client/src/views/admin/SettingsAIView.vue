        ...
        <div v-if="settings.routingMode === 'fixed'">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            >
              ...
              <div class="text-xs text-slate-600">GPT-4o Mini</div>
            ...
            >
              ...
              <div class="text-xs text-slate-600">GPT-4.1</div>
...
const aiProviders = ref({
  ...
  L2: { available: false, name: 'GPT-4o Mini' },
  L3: { available: false, name: 'GPT-4.1' }
})
